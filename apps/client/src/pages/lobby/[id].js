    ...
    return (
        <>
            <main className="h-screen flex flex-col justify-center items-center gap-10">
                ...
                <div>
                    <Typer text={text} progress={progress} setProgress={setProgress} timer={timer} setTimer={setTimer} wpm={wpm} setWpm={setWpm} accuracy={accuracy} setAccuracy={setAccuracy} speedTimeGraph={speedTimeGraph} setSpeedTimeGraph={setSpeedTimeGraph} accuracyTimeGraph={accuracyTimeGraph} setAccuracyTimeGraph={setAccuracyTimeGraph} />
                </div>
            </main>
        </>
    )
